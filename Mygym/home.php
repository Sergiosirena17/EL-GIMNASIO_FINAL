                ...
                <div class="wrapper">
                    <div class="box" style="background: linear-gradient(rgba(0,0,0,.3), rgba('0,0,0,.3')), url('tools/img/training.gif');">
                        <div class="contenido section__data">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae deserunt quibusdam provident dignissimos</p>
                        </div>
                    </div>
                ...
                <div class="box">
                    ...
                    <div class="content_feature">
                        ...
                        <div class="feature_data">
                            <h3>body building</h3>
                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quaerat fuga, animi porro id ipsam iusto eos aliquid ab. Optio nam laborum error nisi quas officia doloribus porro possimus ipsam vel!</p>
